...
echo "<p>".count($dataSet->samples)."</p>";
...
?>
		...
		<tr>
			<td align="center" valign="top">
				...
				<input type="button" style="margin-left: 10px;" value="Geri Dön" onclick="javascript:window.location='<?php echo PATH;?>members/analyze/decisiontree/chooseModel.php';" />
			</td>
		</tr>
		<tr>
			<td height="10">&nbsp;</td>
