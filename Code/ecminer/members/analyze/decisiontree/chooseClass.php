...
if($_SESSION["DecisionTree"]["AnalyzeStep"] != 1) {
...
$test_choice = intval($_SESSION["DecisionTree"]["TestChoice"]);
...
<table class="Table" width="100%" cellpadding="1" cellspacing="0" border="0">
	...
	<tr>
		<td colspan="3" align="center">
			...
			<input type="button" value="Geri Dön" onclick="javascript: window.location='<?php echo PATH;?>members/analyze/decisiontree/default.php';" style="margin-left: 10px;"/>
		</td>
	</tr>
</table>
</form>
